...
// ✅ Connect to MongoDB
mongoose
  .connect("mongodb+srv://alfaceti8:PLWazf6gpmyE_eX@cluster0.0yi51ez.mongodb.net/audihealth?", { useNewUrlParser: true, useUnifiedTopology: true })
...
const seedUsers = async () => {
  ...
  if (!user) {
    user = await User.create({
      email: "bhosa@gmail.com",
      username: "bhosa",
      fullName: "Your Bhosa",
      password: "bhosa@123", // You may hash it later if needed
    });
  }
